...
//
//     final custdetail = custdetailFromJson(jsonString);

import 'dart:convert';

List<Custdetail> custdetailFromJson(String str) =>
    List<Custdetail>.from(json.decode(str).map((x) => Custdetail.fromJson(x)));

String custdetailToJson(List<Custdetail> data) =>
...
class Custdetail {
  ...
  factory Custdetail.fromJson(Map<String, dynamic> json) => Custdetail(
        ...
        tblUser: json["Tbl_User"] != null
            ...
            : <dynamic>[],
        tblPaymentTransactions: json["Tbl_Payment_Transactions"] != null
